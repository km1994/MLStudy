...
class BPNeuralNetwork:
    ...
    def main(self):
        ...
        xiechengDf=pd.read_csv('normalizedPCA_BP_Datadelete4.csv')
        xiecheng_cases_data = np.array(xiechengDf[['hotelClass','hotelLowestprice','hotelComment','surroundingsScore','serviceScore','facilityScore']])
