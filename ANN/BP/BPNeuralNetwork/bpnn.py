...
class BPNeuralNetwork:
    ...
    def main(self):
        ...
        xiechengDf=pd.read_csv('xiecheng1.csv')
        xiecheng_cases_data = np.array(xiechengDf[['hotelClass','hotelLowestprice','hotelComment','healthScore','surroundingsScore','serviceScore','facilityScore']])
